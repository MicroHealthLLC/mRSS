$(function() {
    $('.sidemenu-collapse').on('click', function () {
        ...
        if ($body.hasClass('side-closed')) {
            ...
            $logo.attr('src', '/assets/images/logo-mini.png');
        }
    });
    $(".content, .navbar").mouseenter(function () {
        ...
        $body.addClass('submenu-closed');
        if ($body.hasClass('side-closed')) $('#logo').attr('src', '/assets/images/logo-mini.png');
    });
    $(".sidebar").mouseenter(function () {
        var $body = $('body');
        $body.addClass('side-closed-hover');
        $body.removeClass('submenu-closed');
        if ($body.hasClass('side-closed')) $('#logo').attr('src', '/assets/images/logo.png');
    });
